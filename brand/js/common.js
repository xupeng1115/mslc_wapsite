...
//index.html,wx.html使用
var publicObj = {
    url1:"http://api.mashanglc.com",
    url2:"http://share.mashanglc.com",
    id:getUrlParameter("id") || 0,
    os:getOS().toLowerCase(),
    isWX:isWeixin(),
    nameArr : ["loading页","前页","产品说明页","鸡毛信","下载页","浏览器引导页","浏览器下载页","点击下载"]
} 

var sedRequest = function(name){
    $.get(publicObj.url1+"/v2/open/api/channel/add/log",{"id":publicObj.id,"name":name});
};
