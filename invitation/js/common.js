...
var publicObj = {
    ...
    url:publicApiHost + "/v2/open/api/user/invitation/get/",
    joinUrl:publicApiHost + "/v2/open/api/user/invitation/data",
    downloadUrl:publicApiHost + "/v2/share_app/dl/app/",
    os:getOS().toLowerCase(),
    isWX:isWeixin(),
    userId:getUrlParameter("userId") || 0,
    loginType:getUrlParameter("loginType") || 0,
    appVer:getUrlParameter("appVer")
} 
